                            ...
                            <div id="resultado_fechas" class="mt-3">
                                <div id="range" style="display: none;">
                                    <div class="input-group input-group-sm mt-3">
                                        ...
                                        <input id="initial_date" type="date" class="form-control form-control-sm" max="2025-06-25">
                                    </div>
                                    <div class="input-group input-group-sm mt-3">
                                        <span class="input-group-text">
                                            <i class="fa-regular fa-calendar fa-lg me-1"></i>Final Date
                                        </span>
                                        <input id="final_date" type="date" class="form-control form-control-sm" max="2025-06-25">
                                    </div>
                                </div>
                            </div>
                        </div>
