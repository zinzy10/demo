                            ...
                            <div class="table-responsive">
                                <table id="label" class="table table-sm">
                                    <thead>
                  	                    <tr>
                  	                        <th></th>
                  	                            <th colspan="3" class="text-center" style="background-color: #FAFAFA">2024</th>
                            ...
                            <div class="table-responsive">
                                <table id="treatment" class="table table-sm">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th class="text-center text-secondary fw-bold">2024</th>
                                            <th class="text-center text-secondary fw-bold">2025</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                            ...
                            <div class="table-responsive">
                                <table id="received" class="table table-sm">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th class="text-center text-uppercase text-secondary fw-bold">2024</th>
                                            <th class="text-center text-uppercase text-secondary fw-bold">2025</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
