...
$sql = "SELECT name, last_name, puesto, us_admin FROM {$BD}usuarios.usuarios INNER JOIN {$BD}usuarios.permission ON usuarios.id_usuario = permission.id_user WHERE username = :user";
...
<body>
    <aside class="sidenav navbar dark-mode bar radius-xl fixed-start" id="nBar">
        <div class="sidenav-header">
            ...
            <a href="home_production.php">
                <img src="../assets/img/charly_creative.png" alt="logo" class="brand mt-4">
            </a>
        </div>
        ...
        <div class="w-auto navbar-collapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="#" class="nav-link active bg-orange" onclick="loadContent('dashboard','production')" data-page="production">
                ...
                <nav aria-label="breadcrumb" id="page">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item">
                            <a href="home_production.php" class="text-dark">
