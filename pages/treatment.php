                        ...
                        <div class="col-6 mt-4">
                            ...
                            <div id="range" style="display: none;">
                                <div class="input-group input-group-sm mt-3">
                                    ...
                                    <input id="initial_date" class="form-control form-control-sm" type="date" max="2025-06-25">
                                </div>
                                <div class="input-group input-group-sm mt-3">
                                    <span class="input-group-text">
                                        <i class="fa-regular fa-calendar fa-lg me-1"></i>Final Date
                                    </span>
                                    <input id="final_date" class="form-control form-control-sm" type="date" max="2025-06-25">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 mt-4">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body px-2 pb-2">
                            <div class="table-responsive">
                                <table id="TF7" class="table compact hover">
                                    <thead>
                                        <tr>
                                            <th class="text-secondary fw-bold">Treatment</th>
