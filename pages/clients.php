                            ...
                            <table id="tableClient" class="table compact hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-secondary">2022</th>
                                        <th class="text-center text-secondary">2023</th>
                                        <th class="text-center text-secondary">2024</th>
                                        <th class="text-center text-secondary">2025</th>
                                    </tr>
                                </thead>
                                <tfoot>
                                    <tr>
