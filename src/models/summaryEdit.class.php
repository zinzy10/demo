...
class summaryE {
    ...
    function orders($opc, $client, $d1, $d2, $check) {
        ...
        switch ($opc) {
            case 1:
                ...
                $clientFilter = "%$client%";
                $like = [];
                foreach ($check AS $index => $clientCheck) {
                    $paramName = ':store_' . $index;
                    $like[] = $paramName;
                    $params[$paramName] = $clientCheck;
                }
                $whereMult = "store IN (" . implode(',', $like). ")";
            break;
            ...
            case 2:
                ...
                $like = [];
                foreach ($check AS $index => $clientCheck) {
                    $paramName = ':clients_' . $index;
                    $like[] = "client LIKE " . $paramName;
                    $params[$paramName] = "%$clientCheck%";
                }
                $whereMult = "(" . implode(' OR ', $like) . ")";
            break;
    ...
    function impression($opc, $client, $d1, $d2, $check) {
    ...
    function blanks($opc, $client, $d1, $d2, $check) {
    ...
    function units($opc, $client, $d1, $d2, $check) {
    ...
    function units2($opc, $client, $d1, $d2, $check) {
